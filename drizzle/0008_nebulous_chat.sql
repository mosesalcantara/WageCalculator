...
INSERT INTO `__new_employees`("id", "last_name", "first_name", "middle_name", "rate", "start_day", "end_day", "establishment_id") SELECT "id", "last_name", "first_name", "middle_name", "rate", "start_day", "end_day", "establishment_id" FROM `employees`;--> statement-breakpoint
