...
import { calculatorPeriodFormat, formatNumber } from "@/utils/globals";
...
const CalculatorPage = () => {
  const [periods, setPeriods] = useState([calculatorPeriodFormat]);

  const getTotal = (period: CalculatorPeriod) => {
    const values = {
      ...period,
